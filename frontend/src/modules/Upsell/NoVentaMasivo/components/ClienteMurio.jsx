...
function ClienteFallecido ({onGenerar}) {

    const [nombreContacto, setNombreContacto] = useState("");
    const [tipoPersona, setTipoPersona] = useState("");
    const [ban, setBan] = useState("");
    const [manejoFallecido, setManejoFallecido] = useState("");
    ...
    const generarNotaInterna = () => {
        ...
        if (
            ...
            alert("Debe completar todos los campos de la venta cruzada");
            return;
        }
    ...
    const nota = `Me contacto con ${nombreContacto} (${tipoPersona}), del BAN ${ban}, quien me contesta indica que la persona titular falleció. Manejo realizado: ${manejoFallecido}. Oferta cruzada: ${ofertaCruzadaFinal}, finalizó el contacto.
...
Valor disponible: $${valorDisponible}`;
  ...
  return (
            ...
            <label>Manejo Cliente (Titular Fallecido):</label>
            <textarea
                value={manejoFallecido}
                onChange={(e) => setManejoFallecido(e.target.value)}
                rows={3}
    ...
    export default ClienteFallecido;
