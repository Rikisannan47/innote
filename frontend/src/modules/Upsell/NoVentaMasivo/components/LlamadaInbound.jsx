...
function LlamadaInbound ({onGenerar}) {
...
Detalle: ${detalleOfertaCruzada}`;
        ...
        const nota = `Se contacta ${nombreContacto} (${tipoPersona}), de la línea ${numeroLinea}, por motivo de: ${motivoConsulta}, realizo oferta cruzada: ${ofertaCruzadaFinal}Finalizó el contacto.
