...
function SeguimientoInbound ({onGenerar}) {
    ...
    if (aplicaOfertaCruzada === "Si") {
        ...
        const nota = `Se contacta con ${nombreContacto} (${tipoPersona}), del la línea ${linea}, se le ofrece producto(s): ${productos.join(", ")}. Oferta y equipos ofrecidos: ${ofertaEquipos}. Cliente interesado, se deja seguimiento: ${motivoSeguimiento}.
...
export default SeguimientoInbound;