...
function SeguimientoOutbound ({onGenerar}) {
    ...
    if (aplicaOfertaCruzada === "Si") {
        ...
        const nota = `Me contacto con ${nombreContacto} (${tipoPersona}), del BAN ${ban}, se le ofrece producto(s): ${productos.join(", ")}. Oferta y equipos ofrecidos: ${ofertaEquipos}. Cliente interesado, se deja seguimiento: ${motivoSeguimiento}.
...
export default SeguimientoOutbound;