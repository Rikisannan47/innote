...
const Upsell3PlayCon = ({onGenerar}) => {
    ...
    let nota = `Cliente Titular ${nombre} acepta cambio de plan de ${planActual} con valor de $${valorActual} a ${planAceptado} con un valor de $${valorAceptado} oferta incluye telefonía ILIM PR +LD +50minutos Multi-Destino Renta final $${valorFinal} + IVU, orientado de contrato a ${mesesContrato} meses, penalidad por cada mes restante por cancelación temprana de $${penalidad3Play[mesesContrato]}, se le orienta verá cargos de prorrateo en su próxima factura, 
venta realizada por Grupo especializado ${nombreAsesor}
...
return (
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <input type="text" value={nombre} onChange={e => setNombre(e.target.value)} style={estiloInput} />
            ...
            <input type="text" value={nombreAsesor} onChange={e => setNombreAsesor(e.target.value)} style={estiloInput} />
