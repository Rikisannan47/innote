...
const VentaRenovacion = ({onGenerar}) => {
    ...
    const soloLetras = (valor, setValor) => {
    ...
    const generar = () => { // Función que arma la nota final
    ...
    if (
        ...
        alert("Completa todos los campos obligatorios"); // Alerta si falta alguno
...
export default VentaRenovacion;